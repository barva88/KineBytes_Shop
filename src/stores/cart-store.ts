...
import type { CartItem, ShippingAddress } from '@/types/store';
import { MOCK_PRODUCTS, SHIPPING_OPTIONS } from '@/lib/constants';
...
/* ─────────────────────────────────────────────────────
   Helper React Hooks for Derived Cart Calculations
   Memoized to prevent React useSyncExternalStore infinite re-renders.
   ───────────────────────────────────────────────────── */
